...
var QRByte = require('./QRByte.js');
var Polynomial = require('./Polynomial.js');
var QRUtil = require('./QRUtil.js');
var ErrorCorrectionLevel = require('../common/ErrorCorrectionLevel.js');
var RSBlock = require('./RSBlock.js');
var BitBuffer = require('./BitBuffer.js');
var GIFImage = require('../../image/GIFImage.js');
var MaskPattern = require('../common/MaskPattern.js');
    ...
    Encoder.prototype.write = function (data) {
        if (data instanceof QRData.QRData) {
            ...
            if (type === '[object String]') {
                this.chunks.push(new QRByte.QRByte(data));
            }
            else {
